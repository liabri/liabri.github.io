("Les dictionnaires", 2022-10-10, [linguistics, lexicography], fr-FR)

<span class="lettrine">L</span>a lexicographie, pour ainsi dire l'activité de recensement des unités lexicales, de leurs formes, leur usages et leur sens; à l'objectif de décrire les caractéristiques des mots, élaborer les définitions, vérifiers les étymologies, élaborer des listes d’exemples, dressed les listes d’expression, etc. C'est important de ne confondre pas la lexicographie et la lexicologie.

Ce qui était une transition lisce à la lexicologie, l’étude scientifique des mots; à l'objectif d’établir des règles permettant d’expliquer comment les mots se construisent et comment ils s’organisent les uns par rapport aux autres.

La dictionnarique est l'élaboration, l'établissement d'un dictionnaire à partir des données fourni par un lexicographe.

La métalexicographie c'est l’étude des dictionnaire eux-même, c’est-à-dire leur histoire, leur diversité.

Pendent les années X le mot « dicopathe » s'est afficé, ce qui veut dire : *Personne atteinte d’une passion incurable pour le dictionnaire et qui ne souhaite pas en guérir, mais contaminer le plus de personnes possible.*
...
Noter que les critères groupés ci-dessous ne sont pas mutuellements exclusifs, c’est-à-dire qu'ils peuvent co-éxister à des degrés divers.
...
C’est-à-dire l’orientation vers la **compréhension** d'un mot inconnu, ceux dictionnaires sont caracterisés par une **nomenclature riche** afin de décrire et faire comprendre **le vocabulaire passif**, qui favorise les **définitions** plus facilement compréhensible, plus simple si tu veux qui peuvent être accompagner par des illustrations afin de bien montrer le réferent ou par des synonymes, des **renvois analogique**.
...
Un bon dictionnaire cherche à développer les deux compétences
...
L'évolution des mots, L'histoire de la langue, amplitude chronologique, place consacrée aux emplois vieillis ou archaïques

</td><td style="flex:50%;  border: 0">

#### Synchronique
Même si on trouve des information historique le dictionnaire n'est pas nécessairement diachronique, mais plutôt synchronique.
...
#### dictionnaire de l’entreprise / de l’institution / de l’auteur
#### en un volume / en plusieurs volumes

## La structure
### Macrostructure
<span class="lettrine">L</span>’ensemble des mots ordonnés/traités, c'est-à-dire la nomenclature, oui, *nomen-clat-ure* : mais qu'est-ce que c'est cette putain de monstruosité de mot ?? Un salopard d'amalgamation des mots « [nomes](https://fr.wiktionary.org/wiki/nomen#la) » (nom) et « [classis](https://fr.wiktionary.org/wiki/classis#la) » (classe) en mettant le suffix [-ura](https://fr.wiktionary.org/wiki/-ura#la) car bordel de ses morts pourquoi pas! Cela vient de, quelle surprise, la langue latine. Selon mon bien-amié [wiktionnaire](https://fr.wiktionary.org/wiki/nomenclature) ce mot peut se définir ainsi :

>“Ensemble des mots qui composent un dictionnaire.”

Beh on était juste de relier ce mot-ci à la Macrostructure, ils sont pareil !

Comme tout, les nomenclatures sont susceptibles au changement, ainsi : 
...
* and a lot more, the goal is to choose the type of dictionary (diachronique/synchronque, selectif/general etc.. (from chapter 1) which will dictate the nomenclature).
...
Tout d’abord, il faut définir ces mots-ci :
3. **Homonymie** : des mots qui ont la même forme, mais des sens complétement différents, généralement des etymologiques différents.\
    *eg.* avocat

4. **Polysémie** : un mot qui à plusieurs sens reliés sémantiquement, généralement de la même etymologie.\
    *eg*. une forme **carrée** *vs* une personne **carrée**

**Solution** : Dégroupement homonymique & regroupement Polysémique, c’est-à-dire que les homonymes sont de leur propres lemme, tandis que les polysémes sont de la même lemme.

##### Dégroupement homonymique
##### Regroupement polysémique
...
##### examples pg 28 séance 5
- source attestés (citation) ou forgés\
forgé - made by the lexicograpger\
attesté - found in a book or something
