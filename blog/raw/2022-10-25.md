...
Les propriétés du signe dans la relation entre Signifiant/Signifié :
1. L’arbitraire du signe / le rudiment de motivation : les onomatopées, il y a aussi la thérie de Bouba/Kiki.
...
processus — Réduction par fonctions : et.. et...\
**Les trois types de fonctions syntagmatiques**^[1]^ :
...
**Les trois types de fonctions paradigmatiques**^[2]^ :
...
Il existe plusieurs types de mutation, on peut assigner le mot « synonymique » à celles de variants, car cela implique le manque de changement du sens, contraire à celle d'invariant qui change le sens.
...
L’explicitation de ce principe de non-conformité demande trop de développements théoriques pour être donnée ici. 
